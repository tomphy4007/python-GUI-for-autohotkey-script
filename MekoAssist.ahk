...
MsgBox, Meko Assist - Failed to locate configuration file, Make sure settings.json is placed in the same directory, Exiting.
ExitApp
}
AimbotKey := config.MekoAssist.Binds.Keybind
PauseKey := config.MekoAssist.Binds.Pause
Saturation := config.MekoAssist.Color.Saturation
LinearCurveX := config.MekoAssist.Bezier.LinearCurveX
LinearCurveY := config.MekoAssist.Bezier.LinearCurveY
CameraToGunFOV := config.MekoAssist.Misc.CameraToGunFOV
AimbotUpdateTick := config.MekoAssist.Misc.AimbotUpdateTick
SmoothnessX := config.MekoAssist.Easing.SmoothnessX / LinearCurveX
SmoothnessY := config.MekoAssist.Easing.SmoothnessY / LinearCurveY
SmoothingReplicatorX := config.MekoAssist.Easing.SmoothingReplicatorX
SmoothingReplicatorY := configc.MekoAssist.Easing.SmoothingReplicatorY
SmoothingDividerX := config.MekoAssist.Easing.SmoothingDividerX
SmoothingDividerY := config.MekoAssist.Easing.SmoothingDividerY
FOVOffsetX := config.MekoAssist.FOV.FOVOffsetX
FOVOffsetY := config.MekoAssist.FOV.FOVOffsetY
FlickTime := config.MekoAssist.Misc.FlickTime
AimbotMS := config.MekoAssist.Misc.AimbotUpdateMS
Prediction := config.MekoAssist.Easing.Prediction.Enabled
PredictionMode := config.MekoAssist.Easing.Prediction.Mode
PredictionX := config.MekoAssist.Easing.Prediction.PredictionX
PredictionY := config.MekoAssist.Easing.Prediction.PredictionY
FallbackPixelX := 0
FallbackPixelY := 0
